<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="科室类型" prop="keshileixing">
          <el-select v-model="ruleForm.keshileixing" placeholder="请选择科室类型">
            <el-option
                v-for="(item,index) in keshileixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出诊时间从" prop="chuzhenshijiancong">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.chuzhenshijiancong" 
                type="datetime"
                placeholder="出诊时间从">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuzhenshijiancong" label="出诊时间从" prop="chuzhenshijiancong">
              <el-input v-model="ruleForm.chuzhenshijiancong" 
                placeholder="出诊时间从" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="到" prop="dao">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.dao" 
                type="datetime"
                placeholder="到">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dao" label="到" prop="dao">
              <el-input v-model="ruleForm.dao" 
                placeholder="到" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          chuzhenshijiancong: [
                { required: true, message: '出诊时间从不能为空', trigger: 'blur' },
          ],
          dao: [
                { required: true, message: '到不能为空', trigger: 'blur' },
          ],
          yishengjianjie: [
          ],
          tupian: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshileixing = true;
          ...
          if(o=='chuzhenshijiancong'){
            this.ruleForm.chuzhenshijiancong = obj[o];
	    this.ro.chuzhenshijiancong = true;
            continue;
          }
          if(o=='dao'){
            this.ruleForm.dao = obj[o];
	    this.ro.dao = true;
            continue;
          }
          if(o=='yishengjianjie'){
