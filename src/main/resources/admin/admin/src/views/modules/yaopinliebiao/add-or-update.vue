<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="药品类型" prop="yaopinleixing">
        ...
        <div v-else>
          <el-form-item class="input" label="药品类型" prop="yaopinleixing">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="药品简介" prop="yaopinjianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="药品简介"
                  v-model="ruleForm.yaopinjianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yaopinjianjie" label="药品简介" prop="yaopinjianjie">
                    <span>{{ruleForm.yaopinjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="适用症状" prop="shiyongzhengzhuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="适用症状"
                  v-model="ruleForm.shiyongzhengzhuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongzhengzhuang" label="适用症状" prop="shiyongzhengzhuang">
                    <span>{{ruleForm.shiyongzhengzhuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinleixing = true;
          ...
          if(o=='yaopinjianjie'){
            this.ruleForm.yaopinjianjie = obj[o];
	    this.ro.yaopinjianjie = true;
            continue;
          }
          if(o=='shiyongzhengzhuang'){
            this.ruleForm.shiyongzhengzhuang = obj[o];
	    this.ro.shiyongzhengzhuang = true;
            continue;
          }
          if(o=='jiage'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yaopinliebiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaopinliebiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
